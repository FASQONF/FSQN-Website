...
const TokenomicsSection = () => {
  ...
  const layoutConfig = [
    { id: 'team', percentage: 16, color: '#232323', hoverColor: '#4A4A4A', position: { top: '10%', left: '15%' } },
    ...
    { id: 'advisors', percentage: 2, color: '#FFFFFF', hoverColor: '#FFFFFF', position: { bottom: '20%', right: '5%' } },
    { id: 'private', percentage: 26, color: '#2F8D2D', hoverColor: '#5AE157', position: { bottom: '10%', right: '15%' } },
  ];

  // Adding names to config
  const segments = layoutConfig.map((cfg, idx) => ({
    ...cfg,
    name: t(`tokenomicsSection.segments.${idx}.name`),
  }));
