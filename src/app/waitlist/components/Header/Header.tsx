...
function HeaderComponent() {
  ...
  const navLinks = [
    { name: t("waitlistPage.header.navLinks.waitlist"), href: "#about", external: false },
    { name: t("waitlistPage.header.navLinks.about"), href: "#crypto-cards", external: false },
    { name: t("waitlistPage.header.navLinks.benefits"), href: "#benefits", external: false }
  ];
    ...
    <header className={styles.header}>
      ...
      <div className={styles.right}>
        <Link
          ...
          rel="noopener noreferrer"
        >
          {t("waitlistPage.header.learnMore")}
        </Link>
        {/* <LanguageSwitcher /> */}
      </div>
